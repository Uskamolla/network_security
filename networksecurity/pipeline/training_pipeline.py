...
class TrainingPipeline:
    ...
    def model_training(self, data_transformation_artifact:DataTransformationArtifact)->ModelTrainerArtifact:
    ...
    def model_evaluation(self, data_validation_artifact: DataValidationArtifact, model_training_artifact:ModelTrainerArtifact):
        try:
    ...
    def model_pusher(self,model_eval_artifact:ModelEvaluationArtifact):
        try:
    ...
    def run_pipeline(self):
        try:
            ...
            model_evaluation_artifact = self.model_evaluation(data_validation_artifact=data_validation_artifact, 
            ...
            model_pusher_artifact = self.model_pusher(model_eval_artifact=model_evaluation_artifact)
